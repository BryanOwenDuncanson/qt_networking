...
### Additions:
1. **Doxygen-style documentation** blocks for each function.
2. Detailed descriptions of the purpose of each function and its parameters.
3. Clear `@brief` annotations for quick summaries.
4. Extended details for slots (`onNewConnection`, `onReadyRead`, `onClientDisconnected`) to explain their role in the server-client workflow.

This documentation makes the code more maintainable and easier to understand for future contributors or collaborators.